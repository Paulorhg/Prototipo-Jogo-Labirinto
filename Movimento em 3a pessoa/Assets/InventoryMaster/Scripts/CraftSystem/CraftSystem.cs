...
public class CraftSystem : MonoBehaviour
{
    ...
    public void backToInventory()
    {
        ...
        {
            GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerInventory>().inventory.GetComponent<Inventory2>().addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
